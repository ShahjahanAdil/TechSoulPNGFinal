                ...
                <div className="flex gap-3 ml-4 items-center">
                    <div className="free-btns">
                        <ul className="flex  gap-4">
                            ...
                            <li className="flex items-center gap-2 cursor-pointer !text-[14px] hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => navigate("/images/freebies")}>
                                Freebies
                            </li>
                        </ul>
                    </div>
                    {/* Login Profile */}
                    {userData.userID ? (
                        <div className="nav-profile w-[30px] h-[30px] login relative group cursor-pointer" onClick={() => {
                            window.innerWidth <= 767 && navigate("/dashboard/profile")
                        }}>
                            <img
                                src={userIcon}
                                ...
                                <div className="flex items-center !py-[15px] gap-10">
                                    <div className="flex items-center flex-col">
                                        <p className="!text-[20px] font-bold !text-[#333]">
                                            {dailyDownloadLimit === Infinity ? 'Unlimited' : dailyDownloadLimit}
                                        </p>
                                    ...
                                    <div className="flex items-center flex-col">
                                        <p className="!text-[20px] font-bold !text-[#333]">
                                            {remainingDownloads === Infinity ? 'Unlimited' : remainingDownloads}
                                        </p>
            ...
            <section className="nav-bottom px-5 py-0 bg-[#fefefe] flex justify-between items-center ">
                <div className="menu">
                    <div className="!flex gap-3 sm:!gap-5 justify-start items-center">
                        ...
                        <button className="text-[14px] text-[#333] hover:text-[#4EAA76]" onClick={() => navigate("/dmca")}>DMCA</button>
                        <button className="text-[14px] text-[#333] hover:text-[#4EAA76]" onClick={() => navigate("/legal/terms")}>Terms Of Service</button>
                    </div>
                </div>
            ...
            >
                <div className="flex flex-col gap-3 p-8">
                    ...
                    <ul className="flex flex-col gap-4">
                        {
                            !userData.userID &&
                            <>
                                <li className="flex items-center gap-2 !text-[14px] cursor-pointer hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => navigate("/auth/login")}>
                                    {" "}
                                    <FaRegUser className="!text-[16px]" />
                                    Login
                                </li>
                                <li className="flex items-center gap-2 !text-[14px] cursor-pointer hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => navigate("/auth/signup")}>
                                    {" "}
                        ...
                        <li className="flex items-center gap-2 !text-[14px] cursor-pointer hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => { navigate("/images"); setMenuOpen(false); }}>
                            {" "}
                    ...
                    <div className="free-nav-btns">
                        <ul className="flex flex-col gap-4">
                            <li className="flex items-center gap-2 cursor-pointer !text-[14px] hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => { navigate("/dashboard/subscriptions"); setMenuOpen(false); }}>
                                {" "}
                                Pricing
                            </li>
                            <li className="flex items-center gap-2 cursor-pointer !text-[14px] hover:!text-[#6FD38E] hover:!font-bold transition-all ease-linear duration-200" onClick={() => { navigate("/images/freebies"); setMenuOpen(false); }}>
                                Freebies
                            </li>
                        </ul>
                    </div>
