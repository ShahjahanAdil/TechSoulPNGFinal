                        ...
                        <div className="!w-[100%]">
                            <div className="flex items-center justify-center border border-gray-200 transition-all duration-200 rounded-md ease-linear hover:ring-2 ring-[#71C194] hover:ring-offset-1 ring-offset-slate-50">
                                <div className="relative group inline-block">
                                    ...
                                    <div className="absolute top-[135%] opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 delay-150 bg-white border z-9 border-gray-200 w-45 rounded-[5px]">
                                        <div className="flex flex-col items-start text-[12px] py-2 z-[99999999]">
                                            {[
                                                "PNG",
                                                "JPG",
                                                "WEBP",
