            ...
            >
              ...
              <span
                className={`absolute top-2.5 right-2.5 bg-white ${
                  favourites.some((fav) => fav.imageID === img.imageID)
                    ? "text-red-500"
                    : "text-gray-500"
                } !text-[12px] uppercase p-2 rounded shadow transform scale-0 opacity-0 transition-all duration-500 !flex items-center ease-out group-hover:scale-100 group-hover:opacity-100`}
                onClick={(e) => {
                  e.stopPropagation();
