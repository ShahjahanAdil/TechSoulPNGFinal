...
export default function Stat() {
  const data = [
    {
      icon: <FaUserPlus className="text-[#71c194] text-3xl" />,
      value: "100,000,000+",
      label: "Registered users",
    },
    {
      icon: <FaUser className="text-[#71c194] text-3xl" />,
      value: "147,079",
      label: "Authors",
    },
    {
      icon: <FaDownload className="text-[#71c194] text-3xl" />,
      value: "360,000,000+",
      label: "Total downloads",
    },
    {
      icon: <FaSyncAlt className="text-[#71c194] text-3xl" />,
      value: "10,000+",
      label: "New updates",
    },
  ];
