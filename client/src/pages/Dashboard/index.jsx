            ...
            <div className="flex justify-center items-center">
              <div className="relative mt-5">
                ...
                <div className="absolute bottom-1 -right-1.5 bg-white rounded-full p-1 shadow">
                  <svg className="_tea4l2" xmlns="http://www.w3.org/2000/svg" width="28" height="25" aria-hidden="true" viewBox="0 0 28 23"><defs><linearGradient id="isc2z30a" x1="50%" x2="50%" y1="11.131%" y2="57.082%"><stop offset="0%" stopColor="#C7C7C7"></stop><stop offset="100%" stopColor="#9C9C9C"></stop></linearGradient><linearGradient id="isc2z30c" x1="90.916%" x2="5.301%" y1="61.059%" y2="59.126%"><stop offset="0%" stopColor="#D2D2D2"></stop><stop offset="100%" stopColor="#C4C4C4"></stop></linearGradient><linearGradient id="isc2z30e" x1="100%" x2="22.218%" y1="27.905%" y2="95.888%"><stop offset="0%" stopColor="#E8E8E8"></stop><stop offset="100%" stopColor="#CFCFCF"></stop></linearGradient></defs><path id="isc2z30b" d="M25.455 3.662 22.47 18.458c-.116.35-6.731 1.579-9.755 1.579-2.808 0-9.639-1.23-9.756-1.579L0 3.662l7.948 5.016L12.715 0l4.826 8.678z"></path><g fill="none" fillRule="evenodd"><path fill="url(#isc2z30a)" fillRule="nonzero" d="M9.301 3.906 14 15.866H3.733l4.7-11.96a.467.467 0 0 1 .868 0" transform="rotate(-20 8.867 9.333)"></path><path fill="url(#isc2z30a)" fillRule="nonzero" d="m19.568 3.906 4.699 11.96H14l4.699-11.96a.467.467 0 0 1 .869 0" transform="scale(-1 1)rotate(-20 0 117.844)"></path><g transform="translate(1.281 1.389)"><mask id="isc2z30d" fill="#fff"><use href="#isc2z30b"></use></mask><use fill="url(#isc2z30c)" fillRule="nonzero" href="#isc2z30b"></use><path stroke="#FFF" strokeLinejoin="round" strokeWidth=".933" d="m23.712 14.935-.305.084a41.3 41.3 0 0 1-10.29 1.435l-.328.003v-.002q-5.422-.03-10.617-1.438l-.305-.084" mask="url(#isc2z30d)" opacity=".504"></path></g><ellipse cx="1.909" cy="5.682" fill="url(#isc2z30e)" fillRule="nonzero" rx="1.909" ry="1.894"></ellipse><ellipse cx="14" cy="1.894" fill="url(#isc2z30e)" fillRule="nonzero" rx="1.909" ry="1.894"></ellipse><ellipse cx="26.091" cy="5.682" fill="url(#isc2z30e)" fillRule="nonzero" rx="1.909" ry="1.894"></ellipse><path fill="#FFF" fillRule="nonzero" d="M14.626 15.48a.7.7 0 0 1-1.224.051l-.028-.051-2.1-4.2a.7.7 0 0 1 1.226-.674l.026.048L14 13.602l1.474-2.948a.7.7 0 0 1 .889-.336l.05.023a.7.7 0 0 1 .336.889l-.023.05z" opacity=".7"></path></g></svg>
                </div>
              </div>
            </div>
