                    ...
                    <div className="bg-white p-8 rounded-[12px] border border-[#71C194] shadow-lg w-full max-w-md">
                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2 sm:gap-0">
                                ...
                                <span className="text-sm text-[#71C194] font-medium cursor-pointer hover:underline">Forgot password?</span>
                            </div>
                            ...
                            <p className="text-center text-sm text-gray-500 mt-4">
                                Not registered?{" "}
                                <span className="text-[#71C194] cursor-pointer hover:underline" onClick={() => navigate('/auth/signup')}>
                                    Create an account
                                </span>
                            </p>
